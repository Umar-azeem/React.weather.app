        ...
        <div className="flex center justify-center">
          <div className="w-3/12 bg-teal-500 h-auto flex flex-col text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
            ...
            <div className="flex flex-col justify-center w-full h-auto px-10">
              ...
              {img === "Clear" && <img src={clear} alt="Clear" width={250} height={60} />}
              {img === "Clouds" && <img src={clouds} alt="Clouds" width={250} height={60} />}
              {img === "Drizzle" && <img src={drizzle} alt="Drizzle" width={250} height={60} />}
              {img === "mist" && <img src={humidity} alt="Mist" width={250} height={60} />}
              {img === "Rain" && <img src={rain} alt="Rain" width={250} height={60} />}
              {img === "Snow" && <img src={snow} alt="Snow" width={250} height={60} />}
